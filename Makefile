...
audit:
	...
	@printf '%s\n' README.md CONTRIBUTING.md docs/architecture.md docs/resume-state.md docs/user-stories.md man/taskgrind.1 .devin/skills/standing-audit-gap-loop/SKILL.md .devin/skills/grind-log-analyze/SKILL.md
